...
module.exports.fammeNaPlaylist = function (args,projectDestination)
{
  ...
  console.log('\n\nridotta?    ' + (app.indexOf('Redux')==-1 ? 'No.':'Yes.'));
  ...
  {
      let bitrate = parseInt(fissionModel[modello][i].vb.slice(0,-1)/1000);
