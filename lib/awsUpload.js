...
const client = s3Client.createClient(
    {
        ...
        s3RetryDelay: 400, // this is the default
...
module.exports.upload = (nomeFile) =>
{
    if(weHaveABucket)
    {
        ...
        else
        {
         ...
         console.log('io invece vorrei uplodare su %s', subdir);
...
const watchIt = function(args)
{
    ...
    console.log('osserverei %s', localDir);
    let remoteDir = localDir.split(path.sep).pop()
    console.log('e la uploaderei in  %s', remoteDir);
